...
import time as t
import datetime
# this code is modified from https://github.com/ibaiGorordo/AWR1843-Read-Data-Python-MMWAVE-SDK-3-
...
configFileName = 'radarConfiguration.cfg'
#configFileName = 'tune.cfg'
...
def update():
    ...
    if dataOk and len(detObj["x"])>0:
        ...
        detObj['time'] = round(t.time() - currentTime, 3)
        detObj['frameNumber'] = frameNumber

        FRAMES.append(detObj)
